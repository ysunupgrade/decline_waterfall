...
IF [FICO8_TU] >= 780 THEN
    IF [fprm1] >= 0.12 THEN 27
    ELSEIF [fprm1] >= 0.10 THEN 24
    ELSEIF [fprm1] >= 0.08 THEN 21
    ELSEIF [fprm1] >= 0.06 THEN 16
    ELSEIF [fprm1] >= 0.04 THEN 11
    ELSEIF [fprm1] >= 0.02 THEN 9
    ELSEIF [fprm1] < 0.02 THEN 7
    ELSE 999 END

ELSEIF [FICO8_TU] >= 740 THEN
    IF [fprm1] >= 0.12 THEN 28
    ELSEIF [fprm1] >= 0.10 THEN 25
    ELSEIF [fprm1] >= 0.08 THEN 22
    ELSEIF [fprm1] >= 0.06 THEN 18
    ELSEIF [fprm1] >= 0.04 THEN 12
    ELSEIF [fprm1] >= 0.02 THEN 11
    ELSEIF [fprm1] < 0.02 THEN 9
    ELSE 999 END

ELSEIF [FICO8_TU] >= 700 THEN
    IF [fprm1] >= 0.12 THEN 35
    ELSEIF [fprm1] >= 0.10 THEN 32
    ELSEIF [fprm1] >= 0.08 THEN 28
    ELSEIF [fprm1] >= 0.06 THEN 22
    ELSEIF [fprm1] >= 0.04 THEN 20
    ELSEIF [fprm1] >= 0.02 THEN 14
    ELSEIF [fprm1] < 0.02 THEN 12
    ELSE 999 END

ELSEIF [FICO8_TU] >= 660 THEN
    IF [fprm1] >= 0.12 THEN 37
    ELSEIF [fprm1] >= 0.10 THEN 36
    ELSEIF [fprm1] >= 0.08 THEN 34
    ELSEIF [fprm1] >= 0.06 THEN 32
    ELSEIF [fprm1] >= 0.04 THEN 26
    ELSEIF [fprm1] >= 0.02 THEN 22
    ELSEIF [fprm1] < 0.02 THEN 16
    ELSE 999 END

ELSEIF [FICO8_TU] >= 620 THEN
    IF [fprm1] >= 0.12 THEN 37
    ELSEIF [fprm1] >= 0.10 THEN 36
    ELSEIF [fprm1] >= 0.08 THEN 35
    ELSEIF [fprm1] >= 0.06 THEN 34
    ELSEIF [fprm1] >= 0.04 THEN 32
    ELSEIF [fprm1] >= 0.02 THEN 31
    ELSEIF [fprm1] < 0.02 THEN 31
    ELSE 999 END

ELSEIF [FICO8_TU] >= 580 THEN
    IF [fprm1] >= 0.12 THEN 37
    ELSEIF [fprm1] >= 0.10 THEN 37
    ELSEIF [fprm1] >= 0.08 THEN 36
    ELSEIF [fprm1] >= 0.06 THEN 35
    ELSEIF [fprm1] >= 0.04 THEN 33
    ELSEIF [fprm1] >= 0.02 THEN 32
    ELSEIF [fprm1] < 0.02 THEN 32
    ELSE 999 END

ELSEIF [FICO8_TU] >= 540 THEN
    IF [fprm1] >= 0.12 THEN 37
    ELSEIF [fprm1] >= 0.10 THEN 37
    ELSEIF [fprm1] >= 0.08 THEN 36
    ELSEIF [fprm1] >= 0.06 THEN 35
...
IF [BORROWER_STATE] IN ("WA", "NY") THEN
    IF [PRICING_GRADE_V17] = 1 THEN 0.0899
    ELSEIF [PRICING_GRADE_V17] = 2 THEN 0.0999
    ELSEIF [PRICING_GRADE_V17] = 3 THEN 0.1099
    ELSEIF [PRICING_GRADE_V17] = 4 THEN 0.1199
    ELSEIF [PRICING_GRADE_V17] = 5 THEN 0.1299
    ELSEIF [PRICING_GRADE_V17] = 6 THEN 0.1399
    ELSEIF [PRICING_GRADE_V17] = 7 THEN 0.1499
    ELSEIF [PRICING_GRADE_V17] = 8 THEN 0.1599
    ELSEIF [PRICING_GRADE_V17] = 9 THEN 0.1699
    ELSEIF [PRICING_GRADE_V17] = 10 THEN 0.1799
    ELSEIF [PRICING_GRADE_V17] = 11 THEN 0.1899
    ELSEIF [PRICING_GRADE_V17] = 12 THEN 0.1999
    ELSEIF [PRICING_GRADE_V17] = 13 THEN 0.2099
    ELSEIF [PRICING_GRADE_V17] = 14 THEN 0.2199
    ELSEIF [PRICING_GRADE_V17] = 15 THEN 0.2299
    ELSEIF [PRICING_GRADE_V17] = 16 THEN 0.2399
    ELSEIF [PRICING_GRADE_V17] >= 17 AND [PRICING_GRADE_V17] < 35 THEN 0.2499
    ELSEIF [PRICING_GRADE_V17] >= 35 AND [PRICING_GRADE_V17] <= 40 THEN 0.3599
    END

ELSEIF [BORROWER_STATE] = "NJ" THEN
    IF [PRICING_GRADE_V17] = 1 THEN 0.0899
    ELSEIF [PRICING_GRADE_V17] = 2 THEN 0.0999
    ELSEIF [PRICING_GRADE_V17] = 3 THEN 0.1099
    ELSEIF [PRICING_GRADE_V17] = 4 THEN 0.1199
    ...
    ELSEIF [PRICING_GRADE_V17] = 15 THEN 0.2299
    ELSEIF [PRICING_GRADE_V17] = 16 THEN 0.2399
    ELSEIF [PRICING_GRADE_V17] = 17 THEN 0.2499
    ELSEIF [PRICING_GRADE_V17] = 18 THEN 0.2599
    ELSEIF [PRICING_GRADE_V17] = 19 THEN 0.2699
    ELSEIF [PRICING_GRADE_V17] = 20 THEN 0.2799
    ELSEIF [PRICING_GRADE_V17] = 21 THEN 0.2899
    ELSEIF [PRICING_GRADE_V17] >= 22 AND [PRICING_GRADE_V17] < 35 THEN 0.2999
    ELSEIF [PRICING_GRADE_V17] >= 35 AND [PRICING_GRADE_V17] <= 40 THEN 0.3599
    END

ELSEIF [BORROWER_STATE] = "CO" THEN
    IF [PRICING_GRADE_V17] = 1 THEN 0.0899
    ELSEIF [PRICING_GRADE_V17] = 2 THEN 0.0999
    ELSEIF [PRICING_GRADE_V17] = 3 THEN 0.1099
    ELSEIF [PRICING_GRADE_V17] = 4 THEN 0.1199
    ...
    ELSEIF [PRICING_GRADE_V17] = 11 THEN 0.1899
    ELSEIF [PRICING_GRADE_V17] = 12 THEN 0.1999
    ELSEIF [PRICING_GRADE_V17] >= 13 AND [PRICING_GRADE_V17] < 32 THEN 0.2099
    ELSEIF [PRICING_GRADE_V17] >= 32 AND [PRICING_GRADE_V17] <= 40 THEN 0.3599
    END

ELSEIF [BORROWER_STATE] = "MD" THEN
    IF [PRICING_GRADE_V17] = 1 THEN 0.0899
    ELSEIF [PRICING_GRADE_V17] = 2 THEN 0.0999
    ELSEIF [PRICING_GRADE_V17] = 3 THEN 0.1099
    ELSEIF [PRICING_GRADE_V17] = 4 THEN 0.1199
    ...
    ELSEIF [PRICING_GRADE_V17] = 14 THEN 0.2199
    ELSEIF [PRICING_GRADE_V17] = 15 THEN 0.2299
    ELSEIF [PRICING_GRADE_V17] >= 16 AND [PRICING_GRADE_V17] < 35 THEN 0.2399
    ELSEIF [PRICING_GRADE_V17] >= 35 AND [PRICING_GRADE_V17] <= 40 THEN 0.3599
    END
...
ELSE
    ...
    ELSEIF [PRICING_GRADE_V17] = 20 THEN 0.2799
    ELSEIF [PRICING_GRADE_V17] = 21 THEN 0.2899
    ELSEIF [PRICING_GRADE_V17] = 22 THEN 0.2999
    ELSEIF [PRICING_GRADE_V17] = 23 THEN 0.3099
    ELSEIF [PRICING_GRADE_V17] = 24 THEN 0.3199
    ELSEIF [PRICING_GRADE_V17] = 25 THEN 0.3299
    ELSEIF [PRICING_GRADE_V17] = 26 THEN 0.3399
    ELSEIF [PRICING_GRADE_V17] = 27 THEN 0.3499
    ELSEIF [PRICING_GRADE_V17] >= 28 AND [PRICING_GRADE_V17] <= 40 THEN 0.3599
    END
END
